...
export class CatalogService {
    ...
    async update(id: number, updateCatalogDto: TWithRestaurantId<UpdateCatalogItemDto>) {
        await checkIfCatalogItemBelongsToRestaurant(
            CatalogItem,
            id,
            updateCatalogDto.restaurantId,
    ...
    async findOne(id: number, restaurantId: number) {
        await checkIfCatalogItemBelongsToRestaurant(CatalogItem, id, restaurantId, this.connection.manager);
